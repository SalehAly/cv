...
\begin{tabular}{r|p{17.5cm}}
		...
		\textsc{Jul 2017} & \footnotesize{
			...
			- Using \textbf{Jenkins} to build and deploy Docker containers to Kubernetes clusters.
		}
		\\ \multicolumn{2}{c}{}\\
...
\\\multicolumn{2}{c}{} \\
\textbf{Good}  & Redis, ActiveMQ, Kubernetes, Google Guice, Swagger, Load Testing "Jmeter", Logstash, Kibana (ELK Stack), PHP, Javascript, Nodejs, MongoDB, Vaadin, Jquery, JqueryUI, Bash Scripts, {\fb \LaTeX}
\\\multicolumn{2}{c}{} \\
